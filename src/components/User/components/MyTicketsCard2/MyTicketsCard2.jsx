...
const MyTicketsCard2 = ({ item }) => {
  return (
    <div>
      ...
      <article className="postcard dark blue container-tickets">
        ...
        <div className="postcard__text">
          ...
          <h1 className="postcard__title blue">
            <a href="#">{item.name_event}</a>
          </h1>
          <div className="postcard__subtitle small">
            <time datetime="2020-05-25 12:00:00">
              <i className="fas fa-calendar-alt mr-2"></i>
              {stringToDate(item.date_event)}
            </time>
            <div>
              <i className="fas fa-clock mr-2"></i>
              {stringToTime(item.date_event)}
            </div>
            <div>
          ...
          <ul className="postcard__tagbox">
            <li className="tag__item">
              <button className="btn btn-primary">
                <i className="fas fa-file-download mr-2"></i>Print
              </button>
            </li>
            <li className="tag__item">
              <button className="btn btn-primary">
                <i className="fas fa-gift mr-2"></i>Products
              </button>
            </li>
          </ul>
        </div>
